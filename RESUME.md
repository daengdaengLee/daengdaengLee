...
### About Me
- 자바 & 스프링 개발자로 새롭게 도전중입니다.
    - 더 많은 기회에 도전하고 싶습니다.
    - 복잡해지는 웹 프로그래밍에 맞춰 다양하고 성숙한 해법을 찾고 공부하고 싶습니다.
- 6년 차 웹 프로그래머로 자바스크립트, 타입스크립트 기반으로 웹 서비스를 개발했습니다.
    - 프론트엔드, 백엔드 개발에 모두 참여했습니다.
    - 배치 프로그램 개발 및 유지보수를 진행했습니다.
- 명세와 매뉴얼에 맞게 동작하는 프로그램을 만들려고 합니다. 개발자와 사용자 모두 믿고 쓸 수 있어야 합니다.
- 모르는 기술을 배우는 걸 좋아합니다.
    - 프로그래밍 언어(Rust, Go), 프레임워크(Spring), 라이브러리뿐만 아니라 게임 개발, 머신러닝처럼 주력이 아닌 다른 분야에도 관심이 많습니다.
