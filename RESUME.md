...
- 자체 개발한 함수형 JS, TS 라이브러리(FxJS, FxTS)를 사용하여 Lisp 스타일의 함수형 프로그래밍 방식을 사용
#### CIETY / 백엔드 프로그래머 (2022.06 ~ 2023.06)
- 웹 3 기능을 제공하는 새로운 커뮤니티 빌딩 플랫폼
- TS, pnpm, NestJS, Prisma, Jest, Docker, AWS 사용
...
- JS, TS, Playwright, Docker, AWS 사용
