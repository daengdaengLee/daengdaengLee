...
- 프로젝트 소개: 생성형 모델을 사용한 프로젝트를 쉽게 생성, 관리, 테스트하고 API 형태로 쉽게 서비스를 배포할 수 있는 플랫폼입니다.
- 역할: 사용자 인증 기능 전체를 개발했습니다. 프로젝트 관리를 위해 단위 기능을 제공하는 마이크로서비스 API 를 통합하여 제공하는 API 를 개발했습니다.
- 사용한 기술: Golang, Echo, GORM
