...
- JS / TS + Node.js 로 개발해 왔지만, Java + Spring, Go 같은 기술로 개발하고 싶습니다.
...
- 웹 풀 스택 프로그래머로 커스텀 상품 제작용 벡터 에디터, 생산 자동화 배치 애플리케이션, PFP NFT 프로젝트 빌더, Web3 커뮤니티 서비스 인증 및 인가 서비스를 개발, 유지 보수, 운영했습니다.
